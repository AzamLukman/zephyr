...
*/
int sx1302_init(const struct device *dev, const struct lgw_conf_ftime_s *conf);
...
@return LGW_REG_SUCCESS if success, LGW_REG_ERROR otherwise
*/
int sx1302_lora_syncword(const struct device *dev, bool apublic, uint8_t lora_service_sf);
